...
export const howItWorksText = [
  ...
  'По любым сложностям Сурен ответит в телеграм-чате. Также вопросы можно будет задавать на онлайн-консультации, которые Сурен будет проводить раз в 3-5 недель. Если будет большой спрос на консультации, участим до пары раз в месяц.',
]
