...
export default {
  ...
  stats: {
    ...
    students: 'Студентов',
    modules: '0 модулей | {n} модуль | {n} модуля | {n} модулей',
    topics: '0 тем | {n} тема | {n} темы | {n} тем',
    lessonsPlural: '0 уроков | {n} урок | {n} урока | {n} уроков',
    tasks: '0 задач | {n} задача | {n} задачи | {n} задач',
    studentsPlural: '0 студентов | {n} студент | {n} студента | {n} студентов',
  },
  faq: {
