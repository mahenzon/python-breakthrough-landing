...
export default {
  ...
  stats: {
    ...
    students: 'Студентов',
    modules: 'Модулей | Модуль | Модуля | Модулей',
    topics: 'Тем | Тема | Темы | Тем',
    lessonsPlural: 'Уроков | Урок | Урока | Уроков',
    tasks: 'Задач | Задача | Задачи | Задач',
    studentsPlural: 'Студентов | Студент | Студента | Студентов',
  },
  faq: {
