    ...
    <section class="py-16 bg-gray-50">
      <div class="container mx-auto px-4">
        <div class="max-w-5xl mx-auto">
          ...
          <p class="text-center text-gray-600 mb-12">{{ $t('courseLinks.description') }}</p>
          
          <div class="grid md:grid-cols-2 gap-8 mb-12">
            <!-- Main Site -->
            <div class="bg-white rounded-lg shadow-lg p-8">
              <h3 class="text-2xl font-bold mb-3 text-primary-600">{{ $t('courseLinks.mainSite') }}</h3>
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="inline-block w-full text-center px-6 py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition font-semibold mb-4"
              >
                {{ $t('courseLinks.goToCourse') }} →
              </a>
              <p class="text-sm text-gray-600 italic">{{ $t('courseLinks.mainSiteNote') }}</p>
            </div>
            
            <!-- Stepik -->
            <div class="bg-white rounded-lg shadow-lg p-8">
              <h3 class="text-2xl font-bold mb-3 text-primary-600">{{ $t('courseLinks.stepikSite') }}</h3>
              ...
              <p class="text-sm text-gray-600 italic">{{ $t('courseLinks.stepikNote') }}</p>
            </div>
          </div>
          
          <!-- Value Proposition -->
          <div class="mb-12">
            <h3 class="text-2xl font-bold mb-8 text-center">{{ $t('courseLinks.valueTitle') }}</h3>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div class="bg-white rounded-lg p-6 shadow">
                <h4 class="font-bold text-lg mb-2 text-primary-600">{{ $t('courseLinks.value1Title') }}</h4>
                <p class="text-gray-700">{{ $t('courseLinks.value1Description') }}</p>
              </div>
              <div class="bg-white rounded-lg p-6 shadow">
                <h4 class="font-bold text-lg mb-2 text-primary-600">{{ $t('courseLinks.value2Title') }}</h4>
                <p class="text-gray-700">{{ $t('courseLinks.value2Description') }}</p>
              </div>
              <div class="bg-white rounded-lg p-6 shadow">
                <h4 class="font-bold text-lg mb-2 text-primary-600">{{ $t('courseLinks.value3Title') }}</h4>
                <p class="text-gray-700">{{ $t('courseLinks.value3Description') }}</p>
              </div>
              <div class="bg-white rounded-lg p-6 shadow">
                <h4 class="font-bold text-lg mb-2 text-primary-600">{{ $t('courseLinks.value4Title') }}</h4>
                <p class="text-gray-700">{{ $t('courseLinks.value4Description') }}</p>
              </div>
              <div class="bg-white rounded-lg p-6 shadow">
                <h4 class="font-bold text-lg mb-2 text-primary-600">{{ $t('courseLinks.value5Title') }}</h4>
          ...
          <div class="bg-white rounded-lg shadow-lg p-8 text-center">
            <h3 class="text-2xl font-bold mb-4">{{ $t('courseLinks.invoiceTitle') }}</h3>
            <p class="text-gray-700 mb-6">{{ $t('courseLinks.invoiceDescription') }}</p>
            <div class="flex justify-center gap-4">
              <NuxtLink to="/collaboration" class="px-6 py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition font-semibold">
